...
import com.kerdus.gqasir.ui.adapter.ProductgAdapter
...
class WarehouseFragment : Fragment() {
    ...
    private lateinit var adapter: ProductgAdapter
    private lateinit var viewModel: ProdukgViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(
            this,
            ProdukgViewModelFactory(repository)
        )[ProdukgViewModel::class.java]

        adapter = ProductgAdapter(
            mutableListOf(),
            onItemClick = { product ->
                val bundle = Bundle().apply {
                    putParcelable("produk", product.item)
                }
                findNavController().navigate(R.id.action_WarehouseFragment_to_DetailgFragment, bundle)
            },

            onDelete = { product ->
                val id = product.item.id ?: return@ProductgAdapter
